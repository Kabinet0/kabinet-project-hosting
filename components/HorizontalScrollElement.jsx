...
import styles from "@/styles/horizontal-scroll-element.module.css"; 
import { useEffect, useRef, useState } from "react";
import useIsClientSide from "@/hooks/useIsClientSide";
import useWindowSize from "@/hooks/useWindowSize";


function HorizontalScrollElement({children, button_color}) {
    ...
    //console.log("category colour is currently: " + button_color);
